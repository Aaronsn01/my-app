export default function Facebook({ className }: { className?: string }) {
    return (
      ...
      >
        <rect width="52" height="46" fill="url(#pattern0_127_299)" />
        <defs>
          <pattern
            id="pattern0_127_299"
