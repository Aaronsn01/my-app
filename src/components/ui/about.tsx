...
export default function About() {
  return (
    <div className="container mx-auto md:py-20 md:px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
        <div className="flex justify-center items-center px-4">
          <AboutImage/>
        </div>
        <div className="flex flex-row w-full gap-2 h-fit rounded-md">
          <Separator orientation="vertical" className="md:w-8 md:h-40 bg-primary" />
          <div className="flex flex-col justify-center items-start space-y-4">
            <h2 className="md:text-5xl font-bold text-black text-shadow">
              ¿POR QUÉ UNIRTE A LA TRIBU FITNESS?
            </h2>
            <div className="flex flex-col justify-center items-center gap-5 py-10">
              <div className="md:text-1xl text-black px-4 py-3 rounded-md">
                <h3 className="font-bold md:text-2xl mb-2">ENTRENADORES EXPERTOS</h3>
              ...
              <div className="text-1xl text-black px-4 py-3 rounded-md">
                <h3 className="font-bold md:text-2xl mb-2">CONSIGUE TUS OBJETIVOS</h3>
              ...
              <div className="text-1xl text-black px-4 py-3 rounded-md">
                <h3 className="font-bold md:text-2xl mb-2">ACTIVIDADES APTAS PARA TODOS</h3>
              ...
              <div className="text-1xl text-black px-4 py-3 rounded-md">
                <h3 className="font-bold md:text-2xl mb-2">FLEXIBILIDAD HORARIA</h3>
