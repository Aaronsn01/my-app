  ...
  return (
    <div className="relative min-h-screen">
      <div className="absolute p-4 sm:p-10 lg:pt-48 lg:pl-32 z-50 flex flex-col gap-4">
        <div className="text-lg sm:text-5xl md:text-6xl lg:text-8xl font-bold">
        ...
        <div className="text-[6px] sm:text-2xl lg:text-2xl font-bold">
      ...
      <div className="flex justify-center relative">
        ...
        <div className="flex justify-center items-end absolute w-full h-full mt-[150px] md:mt-10">
